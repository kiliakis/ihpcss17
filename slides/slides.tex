...
%\logo{%
%	\includegraphics[width=1cm,height=1cm,keepaspectratio]{../figures/LogoBadge-01.jpg}
%	\hspace{\dimexpr\paperwidth-2cm-5pt}%
%	\includegraphics[width=1cm,height=1cm,keepaspectratio]{../figures/ntua_logo.jpg}%
%}
