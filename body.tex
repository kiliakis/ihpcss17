...
\begin{frame}
%	\frametitle{Blond in action + short explanation}
%		\begin{columns}[t]
...
%			LHC Blow-up\\
		\begin{textblock}{9}(-0.2,0)
			\begin{figure}[h]
%				\hspace{-12pt}
				\animategraphics[loop, autoplay, width=\textwidth] {10} {figures/LHC_Blow-up/LHC_Blow-up-}{0}{0} %89
...
%			PS-SPS Transfer\\
		\begin{textblock}{5}(-0.2,7)
			\begin{figure}[h]
				\animategraphics[loop, autoplay, width=\textwidth] {8} {figures/PS-SPS_Transfer/PS-SPS_Transfer-}{0}{0} %104
%				\caption*{Insert caption}
			\end{figure}
		\end{textblock}
